...
#app.config['MONGO_URI'] = 'mongodb+srv://mattia_tonelli:laska1989@foodb-jxdvz.mongodb.net/foodb?retryWrites=true&w=majority'

app.config['MONGO_URI'] = 'mongodb+srv://mattia_tonelli:laska1989@cluster0-f6b6v.mongodb.net/foodb'
app.config['SECRET_KEY'] = 'sLgz46L6SAfy4MDtAsdfpdz1bKtO37H728'
